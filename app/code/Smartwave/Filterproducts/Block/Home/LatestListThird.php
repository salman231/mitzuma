...
class LatestListThird extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        $firstCat = $this->storeManager->getValue(
            'custom_cats/select_third_cat/third_cat'
        );
    ...
    public function getProductCount() {
        $firstCatProdCount = $this->storeManager->getValue(
            'custom_cats/select_third_cat/third_no_of_prods'
        );
