...
class LatestListSecond extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        $firstCat = $this->storeManager->getValue(
            'custom_cats/select_second_cat/second_cat'
        );
    ...
    public function getProductCount() {
        $firstCatProdCount = $this->storeManager->getValue(
            'custom_cats/select_second_cat/second_no_of_prods'
        );
