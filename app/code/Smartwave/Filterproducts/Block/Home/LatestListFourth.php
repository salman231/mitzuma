...
class LatestListFourth extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        $firstCat = $this->storeManager->getValue(
            'custom_cats/select_fourth_cat/fourth_cat'
        );
    ...
    public function getProductCount() {
        $firstCatProdCount = $this->storeManager->getValue(
            'custom_cats/select_fourth_cat/fourth_no_of_prods'
        );
