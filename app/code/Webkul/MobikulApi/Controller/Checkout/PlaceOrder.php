...
class PlaceOrder extends AbstractCheckout
{
    public function execute()
    {
        try {
            ...
            $this->returnArray["webview"] = false;
            $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            $urlInterface = $objectManager->create(\Magento\Framework\UrlInterface::class);
            if ($order->getPayment()->getMethodInstance()->getCode() == "payfast") {
                $this->returnArray["webview"] = true;
                $this->returnArray["redirectUrl"] = $urlInterface->getUrl(
                    "mobikulhttp/checkout/payfastredirect"
