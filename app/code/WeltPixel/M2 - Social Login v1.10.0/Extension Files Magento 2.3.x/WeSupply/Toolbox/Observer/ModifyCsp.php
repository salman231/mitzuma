...
class ModifyCsp implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($this->helper->weSupplyHasDomainAlias() && $this->canModifyCsp()) {
     ...
     * @return bool
     */
    private function canModifyCsp(): bool
    {
        return version_compare($this->productMetaData->getVersion(), '1.3.4') > 0;
    }
